...
const UserRecordMolecule = (
  ...
  return <Paper
    ...
    <Stack>
      ...
      <LineRecordAtom el1={'Kiedy konto wygasa: '} el2={dateForUI(user.account.account_expiration_date)}/>
      <LineRecordAtom el1={'Pricing plan: '} el2={getPricingPlanUI(user.account.pricing_plan)}/>
      <LineRecordAtom el1={'Utworzono: '} el2={dateForUI(user.created_at)}/>
      <LineRecordAtom el1={'Data płatności: '} el2={dateForUI(user.account.upcoming_payment_date)}/>
